...
class Memory(object):
    ...
    class __impl:
        ...
        def fix_properties(self, properties):
            if isinstance(properties, unicode) or isinstance(properties, str):
                properties = ast.literal_eval(properties)
            if not isinstance(properties, dict):
                return properties

            for k in properties.keys():
                properties[k] = self.fix_properties(properties[k])
        ...
        def __ros_service_cb(self, data):
            ...
            try:
                ...
                # Remove any quotation marks before adding
                property_dict = self.fix_properties(property_dict)
